var custom = {
  ...
  setTimeForTimeOut: [
    15000, 12000, 30000, 6000, 16000, 22000, 30000, 25000, 25000, 40000, 48000,
  ], //slide 1 time, slide 2 time, slide 3 time, slide 4 btn_1 click time, slide 4 btn_2 click time, slide 4 btn_3 click time,  slide 5 time, slide 6 time, slide 7 time, slide 8 time
  ...
  twinmaxstaggerToVal: function (
    ...
    yoyoVAl,
    animTravelTime,
    callFunctionOnCompleteAnimation
  ) {
    TweenMax.staggerTo(
      $(obj),
      animDuration,
